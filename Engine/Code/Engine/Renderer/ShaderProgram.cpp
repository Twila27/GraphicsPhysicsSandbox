...
//--------------------------------------------------------------------------------------------------------------
STATIC std::map< std::string, ShaderProgram* >	ShaderProgram::s_shaderProgramRegistry;
...
unsigned int ShaderProgram::BindInputAttribute( const std::string& attributeName, unsigned int count, unsigned int glFieldType, bool normalize, int strideInBytes, int offsetInBytes )
{
	unsigned int bindPoint = glGetAttribLocation( m_shaderProgramID, attributeName.c_str() );
...
//--------------------------------------------------------------------------------------------------------------
bool ShaderProgram::SetMatrix4x4( const std::string& uniformNameVerbatim, bool shouldTranspose, const Matrix4x4* val, unsigned int arraySize /*= 1*/ )
{
	...
	if ( loc >= 0 )
	{
		...
		glUniformMatrix4fv( loc, arraySize, (GLboolean)shouldTranspose, (GLfloat*)val ); //shouldTranspose: must be true if using row-major MVP && left-multiplying vert*MVP in shader!.
...
bool ShaderProgram::SetColor( const std::string& uniformNameVerbatim, const Rgba* val, unsigned int arraySize /*= 1*/ )
{
	...
	if ( loc >= 0 )
	{
		Vector4* colorAsFloats = new Vector4[ arraySize ];
...
//--------------------------------------------------------------------------------------------------------------
bool ShaderProgram::SetVector2( const std::string& uniformNameVerbatim, const Vector2* val, unsigned int arraySize /*= 1*/ )
{
	if ( FindUniform( uniformNameVerbatim ) == nullptr )
		return false;
...
//--------------------------------------------------------------------------------------------------------------
bool ShaderProgram::SetVector3( const std::string& uniformNameVerbatim, const Vector3* val, unsigned int arraySize /*= 1*/ )
{
	if ( FindUniform( uniformNameVerbatim ) == nullptr )
		return false;
...
//--------------------------------------------------------------------------------------------------------------
bool ShaderProgram::SetVector4( const std::string& uniformNameVerbatim, const Vector4* val, unsigned int arraySize /*= 1*/ )
{
	if ( FindUniform( uniformNameVerbatim ) == nullptr )
		return false;
