...
public:
	...
	VertexBuffer( unsigned int numElements, unsigned int sizeOfElementInBytes, BufferUsage usage, void* data );
	~VertexBuffer();
	...
	void UpdateBuffer( void* data ); //void* because array can be of vertex class types, or uint indices.
