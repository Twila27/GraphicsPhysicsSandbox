...
public:
	...
	static Texture* CreateTextureFromBytes( const std::string& textureName, const unsigned char* imageData, const IntVector2& textureSizeInTexels, unsigned int numComponents ); //Args from an stbi_load() prior to this call. 
...
private:
	...
	Texture( const unsigned char* imageData, const IntVector2& textureSizeInTexels, unsigned int numComponents ); //Called by CreateFromBytes.
