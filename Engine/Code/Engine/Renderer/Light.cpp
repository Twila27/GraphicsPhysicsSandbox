...
//--------------------------------------------------------------------------------------------------------------
STATIC std::vector<Light*>		Light::s_lightRegistry;
...
//--------------------------------------------------------------------------------------------------------------
STATIC Light* Light::CreateLight( LightType type, const Vector3& position, const Vector3& direction, const Rgba& color,
...
{
	ASSERT_OR_DIE( ( s_lightRegistry.size() + 1 ) <= MAX_LIGHTS, "Exceeded MAX_LIGHTS in CreateOrGetLight!" );
	if ( s_lightRegistry.size() + 1 > MAX_LIGHTS )
		return nullptr;
...
//--------------------------------------------------------------------------------------------------------------
STATIC void Light::GetLightPositions( Vector3* out )
{
...
//--------------------------------------------------------------------------------------------------------------
STATIC void Light::GetLightDirections( Vector3* out )
{
	for ( unsigned int lightIndex = 0; lightIndex < s_lightRegistry.size(); lightIndex++ )
...
//--------------------------------------------------------------------------------------------------------------
Light::Light( LightType type, const Vector3& position, const Vector3& direction, const Rgba& color,
			  float minLightDistRadius /*= 0.f*/, float maxLightDistRadius /*= INFINITY*/,
			  float powerAtMinDist /*= 0.f*/, float powerAtMaxDist /*= 0.f*/,
			  float innerAngleCosine /*= 0.f*/, float outerAngleCosine /*= 0.f*/,
...
//--------------------------------------------------------------------------------------------------------------
void Light::MakePointLight( const Vector3& position, const Vector3& direction, const Rgba& color, 
...
//--------------------------------------------------------------------------------------------------------------
void Light::MakeSpotLight( const Vector3& position, const Vector3& direction, const Rgba& color, 
...
//--------------------------------------------------------------------------------------------------------------
void Light::MakeDirectionalLight( const Vector3& position, const Vector3& direction, const Rgba& color )
{
	m_position = position;
	m_direction = direction;
	m_color = color;
