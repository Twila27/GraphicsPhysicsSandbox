...
//	if ( m_shaderProgram->FindAttribute( attributeNameVerbatim )  )
	int bindPoint = m_shaderProgram->BindInputAttribute( attributeNameVerbatim, count, GetOpenGLVertexFieldType( engineFieldType ), normalize, strideInBytes, offsetInBytes );
...
//--------------------------------------------------------------------------------------------------------------
void Material::SetVector2( const std::string& uniformNameVerbatim, const Vector2* newValue, unsigned int arraySize /* = 1 */ )
{
...
//--------------------------------------------------------------------------------------------------------------
void Material::SetVector3( const std::string& uniformNameVerbatim, const Vector3* newValue, unsigned int arraySize /* = 1 */ )
{
...
//--------------------------------------------------------------------------------------------------------------
void Material::SetVector4( const std::string& uniformNameVerbatim, const Vector4* newValue, unsigned int arraySize /* = 1 */ )
{
...
//--------------------------------------------------------------------------------------------------------------
void Material::SetMatrix4x4( const std::string& uniformNameVerbatim, bool shouldTranspose, const Matrix4x4* newValue, unsigned int arraySize /* = 1 */ )
{
