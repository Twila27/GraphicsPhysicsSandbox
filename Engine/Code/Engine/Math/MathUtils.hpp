...
//-----------------------------------------------------------------------------
//Randomness Math
float GetRandomFloatFromZeroTo( float maximum );
...
//-----------------------------------------------------------------------------------------------
inline float GetRandomFloatFromZeroTo( float maximum )
{
	TODO( "Use a faster, better random number generator." );
	const float oneOverRandMax = 1.f / static_cast< float >( RAND_MAX / maximum );
...
{
	TODO( "Use a faster, better random number generator." );
	const float randomZeroToOne = GetRandomFloatFromZeroTo( 1.f );
...
inline bool GetRandomChance( float probabilityOfReturningTrue )
{
	...
	return GetRandomFloatFromZeroTo( 1.f ) < probabilityOfReturningTrue;
}